...
namespace SchedulerBindToObservableCollectionWpf {
    public class SchedulerViewModel {
        ...
        public SchedulerViewModel() {
            ...
            AddNewAppointmentCommand = new DelegateCommand<object>(AddNewAppointmentCommandExecute);
            GetSourceObjectCommand = new DelegateCommand<object>(GetSourceObjectCommandExecute);
