...
Namespace SchedulerBindToObservableCollectionWpf
	Public Class SchedulerViewModel
		...
		Public Sub New()
			...
			AddNewAppointmentCommand = New DelegateCommand(Of Object)(AddressOf AddNewAppointmentCommandExecute)
			GetSourceObjectCommand = New DelegateCommand(Of Object)(AddressOf GetSourceObjectCommandExecute)
